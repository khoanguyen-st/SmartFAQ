...
const Pagination: React.FC<PaginationProps> = ({
  ...
  <div className="flex items-center justify-end border-t border-gray-200 px-4 py-3 sm:px-6">
    <div className="hidden sm:flex sm:items-center sm:gap-4">
      {/* Showing text */}
      <div className="flex w-[150px] h-6 items-center justify-end whitespace-nowrap text-right font-medium text-base leading-6 text-gray-900 opacity-60">
      ...
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className={`flex h-9 w-[70px] items-center justify-between rounded-lg border border-gray-200 bg-white px-3 text-base font-normal leading-6 text-gray-700 hover:bg-gray-50 focus:outline-none ${
