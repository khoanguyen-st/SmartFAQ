      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 flex-1 overflow-hidden">
          <input
            ...
            className={`px-3 py-2 border border-gray-300 rounded-md shadow-sm outline-none focus:ring-[#0003dd] focus:border-[#0003dd]
              flex-1 transition-colors duration-200 ease-in-out 
              ${
                isEditing
                  ? 'bg-white focus:ring-[#003087] focus:border-[#003087] out-line-none'
                  : isEditable
