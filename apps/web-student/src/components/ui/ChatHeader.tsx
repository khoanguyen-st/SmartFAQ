...
const ChatHeader = ({ 
  ...
  subtitle = "Document-based chatbot training system",
  actionNode,
  additionalActions 
}: ChatHeaderProps) => {
  return (
    <div className="chat__header flex items-center justify-between px-6 py-4 border-b border-[#E5E7EB] bg-white sticky top-0 z-10">
      ...
      <div className="flex items-center">
        <img 
          ...
          width={40} 
          height={40} 
          className='rounded-full bg-[#00033d] mr-3 shrink-0 p-1'
        />
