...
# Defaults used when source metadata is missing
...
class ResponseFormatter:
    ...
    def __init__(self, document_preview_url: Optional[str] = None):
        ...
        self.highlight_patterns = [
            ...
            (
                re.compile(r"\b(Khoa|Ngành|Chương trình|Đại học|Cao đẳng)\b", flags=re.IGNORECASE),
                r"**\1**",
            ),
    ...
    def format(
        self, raw_answer: str, sources: List[Dict[str, Any]], fallback_triggered: bool = False
    ) -> Dict[str, Any]:
