...
class LLMWrapper:
    def __init__(
        ...
        self.system_prompt = (
            ...
            "2. LANGUAGE RULE: You MUST answer in the language specified by 'target_language'.\n"
            "   - If target_language is 'en' and Context is Vietnamese -> TRANSLATE the information to English.\n"
            "   - If target_language is 'vi' -> Answer in Vietnamese.\n"
            "3. If the Context does not contain the answer, strictly say 'I could not find information' (in the target language).\n"
            "4. Do not mention 'according to the document', just answer directly.\n"
        )
